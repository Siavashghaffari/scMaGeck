...
## Run on a list of ED genes
genes_list=read.csv("genes_list_from_ED.csv")
genes_list1<-genes_list$gene_symbol
eff_object <- scmageck_eff_estimate(rds_object, bc_frame, perturb_gene=genes_list1, 
                                    non_target_ctrl = 'NTC')
