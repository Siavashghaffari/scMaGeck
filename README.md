...
```
cd existing_repo
git remote add origin https://code.roche.com/ghaffars/scmageck.git
git branch -M main
...
- [ ] [Set up project integrations](https://code.roche.com/ghaffars/scmageck/-/settings/integrations)
